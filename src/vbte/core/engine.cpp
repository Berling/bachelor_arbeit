...
namespace vbte {
	namespace core {
		...
		void engine::update(float delta_time) {
			...
			//static terrain::terrain_cell t{*this, *terrain_system_, glm::vec3{0.f}, glm::angleAxis(glm::radians(0.f), glm::vec3{0.f}), "terrain/test.vol"};
			...
			terrain_system_->update(delta_time);
